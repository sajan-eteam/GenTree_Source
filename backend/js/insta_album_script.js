...
$(function(){
	...
	dropbox.filedrop({
		...
		paramname:'pic',
		url: 'insta_img_file.php', //this is the PHP file used for processing
		...
		$("#upl").click(function(){
			...
			// the script where you handle the form input.
				$.ajax({
				   ...
				   {
						location.href='insta_album_detail.php';
	...
	$("#can").click(function(){
    var url      = 'insta_img_file.php'; // the script where you handle the form input.
