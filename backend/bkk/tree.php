            ...
            <div id="tabella_head" class="table_head_main">
                <div id="top_right">
                    ...
                    <form id="cont_search" method="get" onSubmit="javascript:doSearch();return false;">
                        ...
                        <label>
                            <input id="search" class="search" type="text" value="<?php echo $_POST['searchtitle']; ?>" onkeydown="search_check()" onblur="search_check()" placeholder="Cerca">
                        </label>
                    </form>
                </div>
            ...
            <div id="tabella">
				...
				?>
                    <tr class="table_link preview">
                        ...
                        <td class="col1">
                        	<p><a href="tree_detail.php?gene_user_id=<?php echo $family_members[$i]['gene_user_id']; ?>"><?php echo stripslashes($family_members[$i]['gene_name']);?></a></p>
                        </td>
                        <td class="col2"><p><?php echo stripslashes($family_members[$i]['gene_surname']);?></p></td>
