					...
					if(error_flag	==	0)
					{
							...
							$.ajax({
									...
									success: function(data) 
									{
										if(data == 1)
										{	
											//$("#msg").addClass('Successfully Saved');
											//$("#msg").show();
											window.location = "tree_detail.php?gene_user_id="+$gene_user_id+"&&success=success";
										}
										else
										{  
        ...
        <div id="tabella_cont" class="table_main">
            ...
            <div id="tabella">
                <div id="middle_colom">
                    ...
                    <div id="name"><p>Nome*</p><input type="text" id="nome" value="<?php echo stripslashes($gene_user_details['gene_name']); ?>"/></div>
                    <div id="sur_name"><p>Cognome*</p><input type="text" id="surname" value="<?php echo stripslashes($gene_user_details['gene_surname']);?>"/></div>
                    <div id="user_name"><p>Soprannome</p><input type="text" id="username" value="<?php echo htmlentities(html_entity_decode($gene_user_details['gene_nickname'])); ?>"/></div>
                    <div id="gen_der">
                    	<p>Sesso*</p><p>
                    ...
                    <div id="place_birth"><p>Luogo di nascita</p><input type="text" id="placebrth" value="<?php echo htmlentities(html_entity_decode($gene_user_details['gene_place_birth'])); ?>"/></div>
                    ...
                    <div id="alive_opt1" style="display:<?php if($gene_user_details['gene_in_life']== '1') { echo "block";} else echo "none"; ?>;">
                    	<div><p>Residente in</p><input type="text" id="resident" value="<?php echo htmlentities(html_entity_decode($gene_user_details['gene_resident_in'])); ?>"/></div>
                    	<div><p>Cap</p><input type="text" id="cap" value="<?php echo htmlentities(html_entity_decode($gene_user_details['gene_cap'])); ?>"/></div>
                    	<div><p>Città</p><input type="text"id="city" value="<?php echo htmlentities(html_entity_decode($gene_user_details['gene_city'])); ?>"/></div>
                    	<div><p>Provincia</p><input type="text" size="2"id="province" value="<?php echo htmlentities(html_entity_decode($gene_user_details['gene_province'])); ?>"/></div>
                    	<div><p>Nazione</p><input type="text"id="country" value="<?php echo htmlentities(html_entity_decode($gene_user_details['gene_nation'])); ?>"/></div>
