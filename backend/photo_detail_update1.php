                   ...
                   if(error_flag	==	0)
					{
							...
							$.ajax({
									...
									data:'imageid='+$imageid+'&galleryid='+$albumid+'&title='+$title+'&image='+$src+'&desc='+$desc+'&status='+$status+'&imagedat='+$imgdate+'&boxdetail='+$boxdetail+'&delstatus='+$delstatus+'&deluserid='+$deluserid,
            ...
            <div id="tabella">
                <div id="middle_colom">
					...
					<?php  $image_name		= $objimage->imageview($image_id); 
						  ...
						  ?>
                    	<input id="photoTitle" name="title" type="text" value="<?php echo html_entity_decode(stripslashes($title));?>" size="45" placeholder="Titolo della foto"/>
                    </div>
                    <div class="box">
                    ...
                    <div id="description" class="box">
                        ...
                        <table>
                            <tr>
                                <td>
                                    <textarea id="smallDesc" name="smallDesc"><?php 
									echo html_entity_decode(stripslashes($description));?></textarea>
                                </td>
                            </tr>
                        </table>
                        </div>
					 ...
					 <div>
                                ...
                                <select id="album">
								    <?php $galleryResult  = $objimage->getGalleryLists();
									      ...
									      $galleryimage   = $objimage->getGallery($gallery);
