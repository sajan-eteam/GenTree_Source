...
jQ(document).ready(function() {	
	...
	jQ('img[menu="top"]').mouseover(function() {
		...
		else if(jQ(this).attr('id') == 'main6') {
			if(jQ('#div_main6').css('display') == 'block') {
				jQ(this).attr('src', '../includes/img/menu/menu_bg2.gif');	
			}
			else {
				jQ(this).attr('src', '../includes/img/menu/menu_bg1.gif');
		...
		else if(jQ(this).attr('id') == 'main7') {
			if(jQ('#div_main7').css('display') == 'block') {
				jQ(this).attr('src', '../includes/img/menu/menu_bg2.gif');	
			}
			else {
				jQ(this).attr('src', '../includes/img/menu/menu_bg1.gif');
		...
		else if(jQ(this).attr('id') == 'main8') {
			if(jQ('#div_main8').css('display') == 'block') {
				jQ(this).attr('src', '../includes/img/menu/menu_bg2.gif');	
			}
			else {
				jQ(this).attr('src', '../includes/img/menu/menu_bg1.gif');
		...
		else if(jQ(this).attr('id') == 'main9') {
			if(jQ('#div_main9').css('display') == 'block') {
				jQ(this).attr('src', '../includes/img/menu/menu_bg2.gif');	
			}
			else {
				jQ(this).attr('src', '../includes/img/menu/menu_bg1.gif');
	...
	jQ('#main4').click(function() {
		...
		if(id == 'main4') {			
			if(jQ('#div_main4').css('display') == 'block') {
				...
				jQ('#anchor_main4').attr('class', 'pad');
				jQ(this).attr('src', '../includes/img/menu/menu_bg1.gif');
			}
			else {
				...
				jQ('#anchor_main4').attr('class', 'pad2');
				jQ(this).attr('src', '../includes/img/menu/menu_bg2.gif');				
			}
		}
	});
...
jQ('#main5').click(function() {
		...
		if(id == 'main5') {			
			if(jQ('#div_main5').css('display') == 'block') {
				...
				jQ("#div_main5").show("slow", function() { 					
					jQ('#div_main7').css('display', 'block');						
				}); 
	...
	jQ('#main6').click(function() {
		id = jQ(this).attr('id');
		if(id == 'main6') {			
			if(jQ('#div_main6').css('display') == 'block') {
				jQ('#div_main6').css('display', 'none');					
				jQ('#anchor_main6').attr('class', 'pad');									
				jQ(this).attr('src', '../includes/img/menu/menu_bg1.gif');				
			}
			else {
				jQ("#div_main6").show("slow", function() { 					
					jQ('#div_main8').css('display', 'block');						
				}); 
				jQ('#anchor_main6').attr('class', 'pad2');				
				jQ(this).attr('src', '../includes/img/menu/menu_bg2.gif');							
			}
		}
	});
	jQ('#main7').click(function() {
		id = jQ(this).attr('id');
		if(id == 'main7') {			
			if(jQ('#div_main7').css('display') == 'block') {
				jQ('#div_main7').css('display', 'none');					
				jQ('#anchor_main7').attr('class', 'pad');									
				jQ(this).attr('src', '../includes/img/menu/menu_bg1.gif');				
			}
			else {
				jQ("#div_main7").show("slow", function() { 					
					jQ('#div_main7').css('display', 'block');						
				}); 
				jQ('#anchor_main7').attr('class', 'pad2');				
				jQ(this).attr('src', '../includes/img/menu/menu_bg2.gif');							
			}
		}
	});

	jQ('#main8').click(function() {
		id = jQ(this).attr('id');
		if(id == 'main8') {			
			if(jQ('#div_main8').css('display') == 'block') {
				jQ('#div_main8').css('display', 'none');					
				jQ('#anchor_main8').attr('class', 'pad');									
				jQ(this).attr('src', '../includes/img/menu/menu_bg1.gif');				
			}
			else {
				jQ("#div_main8").show("slow", function() { 					
					jQ('#div_main8').css('display', 'block');						
				}); 
				jQ('#anchor_main8').attr('class', 'pad2');				
				jQ(this).attr('src', '../includes/img/menu/menu_bg2.gif');							
			}
		}
	});
		jQ('#main9').click(function() {
		id = jQ(this).attr('id');
		if(id == 'main8') {			
			if(jQ('#div_main9').css('display') == 'block') {
				jQ('#div_main9').css('display', 'none');					
				jQ('#anchor_main9').attr('class', 'pad');									
				jQ(this).attr('src', '../includes/img/menu/menu_bg1.gif');				
			}
			else {
				jQ("#div_main9").show("slow", function() { 					
					jQ('#div_main9').css('display', 'block');						
				}); 
				jQ('#anchor_main9').attr('class', 'pad2');				
				jQ(this).attr('src', '../includes/img/menu/menu_bg2.gif');							
			}
		}
	});
