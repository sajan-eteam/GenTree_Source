...
getmenuHTML:function(menuobj){
	...
	for (var i=0; i<menuobj.items.length; i++){
		if(i==(menuobj.items.length-1)){
			if(menuobj.items[i][0] == 'delete') { //Modified by Shery for category section.  The previous code is commented below.
				frag+='<a class="js_font_red" href="' + menuobj.items[i][1] + '" target="' + menuobj.linktarget + '">' + menuobj.items[i][0] + '</a>\n'
			}
			else {
				frag+='<a class="js_font" href="' + menuobj.items[i][1] + '" target="' + menuobj.linktarget + '">' + menuobj.items[i][0] + '</a>\n'
			}	
			//frag+='<a class="js_font" href="' + menuobj.items[i][1] + '" target="' + menuobj.linktarget + '">' + menuobj.items[i][0] + '</a>\n'
		}else{
